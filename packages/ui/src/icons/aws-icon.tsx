...
export function AwsIcon({ className, accentColor, ...props }: AwsIconProps) {
  const colored = Boolean(accentColor);
  const smileFill = accentColor ?? "#FF9900";
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path fill="currentColor" d={AWS_WORDMARK_D} />
      {colored ? (
        <>
          <path fill={smileFill} d={AWS_SMILE_A_D} />
          <path fill={smileFill} d={AWS_SMILE_B_D} />
        </>
      ) : (
        <>
          <path fill="currentColor" d={AWS_SMILE_A_D} />
          <path fill="currentColor" d={AWS_SMILE_B_D} />
        </>
      )}
    </svg>
  );
