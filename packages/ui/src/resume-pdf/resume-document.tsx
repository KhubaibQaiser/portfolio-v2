...
const s = StyleSheet.create({
  ...
  summarySection: { marginTop: 6 },
  expEntry: { marginBottom: 2 },
  expHeaderBlock: { marginBottom: 1 },
  expHeader: {
    flexDirection: "row",
  ...
  bulletList: { marginTop: 2, paddingLeft: 10 },
  ...
  skillLine: { fontSize: 9.5, color: COLORS.body, marginBottom: 2, lineHeight: 1.28 },
  skillCategory: {
    fontFamily: "Helvetica-Bold",
    color: COLORS.accent,
  },
  eduLine: { fontSize: 9.5, color: COLORS.body, lineHeight: 1.28 },
  certRow: { flexDirection: "row", marginBottom: 1.25 },
  ...
  metaBody: { fontSize: 9.5, color: COLORS.body, lineHeight: 1.28 },
});
