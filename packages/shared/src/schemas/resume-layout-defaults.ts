  ...
  return {
    formatting: {
      ...
      typography: {
        headingFont: "Carlito",
        bodyFont: "Carlito",
        headingSizes: { name: 22, title: 11, section: 11, job: 9.5, company: 10 },
        bodySizes: { contact: 9, body: 9.5, meta: 9, skills: 8.5, location: 8.5 },
      },
      spacing: {
        pageMargins: "13mm top/bottom, 14mm left/right",
        sectionGap: 8,
        jobGap: 6,
        bulletIndent: 12,
      },
