...
const ERROR_MESSAGES: Record<string, string> = {
  unauthorized: "This email is not authorized to access the admin dashboard.",
  ...
  missing_auth_params: "Invalid authentication request.",
};
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        {sent ? (
          <div className="mt-8 flex items-center gap-3 rounded-xl bg-green-500/10 p-4 text-sm text-green-600 dark:text-green-400">
            ...
            {showMagicLink ? (
              <form onSubmit={handleMagicLink} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex w-full items-center justify-center gap-2 rounded-lg bg-accent px-4 py-2.5 text-sm font-medium text-accent-foreground transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  Send Magic Link
