...
function CommandItem({
  ...
  return (
    <Command.Item
      onSelect={onSelect}
      className="text-muted-foreground data-[selected=true]:bg-accent/10 data-[selected=true]:text-foreground flex cursor-pointer items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors"
    >
